...
<link rel="icon" href="/img/favicons/favicon-32.png" sizes="32x32">
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
		...
		<link rel="stylesheet" type="text/css" href="Designing/animate.css">
		<link rel="stylesheet" type="text/css" href="assets/css/bootstrap.min.css">
		<link rel="stylesheet" type="text/css" href="assets/css/font-awesome.min.css">
		<link rel="stylesheet" type="text/css" href="Designing/main.css">
		<link rel="stylesheet" type="text/css" href="Designing/flexslider.css">
		<link rel="stylesheet" type="text/css" href="Designing/owl.carousel.css">
	</head>
	...
	<body>
		...
		<section class="blog-title text-center">
			<div class="blog-wrapper">
				<div class="container">
					<div class= "row">	
						<h1 class="headline">Welcome to HealthCare And Route Management Application Blogs</h1>
					</div>
					<div class="row">
						...
						<div class="widget widget_iw_last_posts" id="iw_last_posts-3">
							...
							<div class="row">
								<div class="col-md-4 col-xs-3">
									<a href="#">
										<img src="https://github.com/technext/HealthCare/blob/master/assets/img/blog1.jpg" class="img-responsive h5 wp-post-image" alt="Medical Theme Health and Care">
									</a>
								</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="copy-right-text text-center">
							&copy; Copyright 2014, Your Website Link. Theme by <a href="https://healthcarebynitinraj.com">Hleathcare Application</a>
						</div>
					</div>
				</div>
			</div>
