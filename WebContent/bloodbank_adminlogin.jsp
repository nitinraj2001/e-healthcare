    ...
    <div id="header">
      <div id="logo">
        <div id="logo_text">
          ...
          <h1><a href="bloodManagement_indexpage.jsp">Blood Bank Management <span class="logo_colour">System</span></a></h1>
      ...
      <div id="menubar">
        <ul id="menu">
		  ...
		  <li class="selected"><a href="bloodbank_adminlogin.jsp">Administrative Log In</a></li>
        </ul>
      </div>
    </div>
