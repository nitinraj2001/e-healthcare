...
<body>
  ...
  <h1 align="center"><u>Administrator Login Interface</u></h1><br><br>
  ...
  <div class="container" id="container">
    ...
    <div class="form-container sign-up-container">
       ...
       <form action="Admin_SignUpServlet" method="get">
    ...
    <div class="form-container sign-in-container">
      ...
      <form action="Admin_SignInServlet" method="post">
    ...
    <div class="overlay-container">
      ...
      <div class="overlay-panel overlay-right">
       ...
       <p>Enter your details and start monitoring the functionality of the application. </p>
