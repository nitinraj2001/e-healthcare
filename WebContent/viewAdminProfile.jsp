...
Query q=s.createQuery("From AdminHealthCareLogin");

List<AdminHealthCareLogin> list=q.list();

for(AdminHealthCareLogin reg:list){
	
	
	if(reg.getAdmin_name().equalsIgnoreCase("Nitin Raj")){
...
<div >
  ...
  <h1><%=reg.getAdmin_name() %></h1>

  
 
  
 
  <p ><b>Email-Id: </b><%=reg.getAdmin_email() %></p>
  
  <p><b>Contact-No: 9560293905 </b></p>
...
<p>Go back to your  <a href="adminFunctionality.jsp">functionality page</a></p>
