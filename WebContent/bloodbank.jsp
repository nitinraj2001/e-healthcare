    ...
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li><a href="bloodbank_contact.jsp">Contact Us</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
        <h1 align="left"><font color="blue"><b>Blood Bank Information:</b></font></h1>
          ...
          <% 
            Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/technology","root","root");
        ...
        <table border="" style="width:200px">
            <tr>
                <th>ID</th>
