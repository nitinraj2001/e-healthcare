<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="org.hibernate.Session" %>
     ...
     <%@page import="mypack.helper.ConnectionProvider" %>
      ...
      <%@page import="mypack.entity.DoctorRegistration" %>
...
<div class="register-photo">
    <div class="form-container">
        ...
        <form method="post" action="Doc_UpdateServlet">
            <h2 class="text-center"><strong>Update </strong> yourself doctor.</h2>
        
            <input value="<%=doc.getDoctor_id()%>" name="doctor_id" type="hidden"/><br><br>
          
            
             <div class="form-group"><input class="form-control" type="text" name="doctor_degree" placeholder="Degree" value="<%=doc.getDoctor_degree()%>"></div>
                  
             <div class="form-group"><input class="form-control" type="digit" name="doctor_contact" placeholder="ContectNumber" value="<%=doc.getDoctor_contactno()%>"></div>
